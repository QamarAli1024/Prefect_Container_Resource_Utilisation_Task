...
from davinci.utils.global_config import ENV, PROD
...
def build_deployment():
    ...
    deployment = Deployment.build_from_flow(
        flow=main,
        name=f"prefect-container-resource-utilisation-task-deployment-{ENV}", # TODO, name this whatever you wish. Keep the suffix ENV for tracking purposes.
        ...
        is_schedule_active=PROD,
        schedule=(CronSchedule(cron="00 9 * * Fri", timezone="America/New_York")),
